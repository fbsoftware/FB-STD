            ...
            <div>
                ...
                <section class="style-section">
                    ...
                    <div class="style-control" style="display: flex;">
                        <label>Primary</label>
                        <input type="color" value="#3366ff" data-site-color="primary">
                        </div>
                    <div class="style-control" style="display: flex;">
                        <label>Secondary</label>
                        <input type="color" value="#ff6633" data-site-color="secondary">              
                        </div>
                    <div class="style-control" style="display: flex;">
                        <label>Accent</label>
                        <input type="color" value="#ffa500" data-site-color="accent">
                    </div>
                    <div class="style-control" style="display: flex;">
                        <label>Testo</label>
                        <input type="color" value="#222222" data-site-color="text">
                    </div>
                    <div class="style-control" style="display: flex;">
                        <label>Sfondo</label>
                        <input type="color" value="#ffffff" data-site-color="bg">
                </section>
...
window.INITIAL_LAYOUT = <?= json_encode($layoutData) ?>;
 ...
 <script>
  $( function() {
    ...
    $( "#widget-details .panel-body" ).accordion({
        header: "h3",
        heightStyle: 'content',  
        collapsible: true,
        active: 0,  

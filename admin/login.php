...
echo  "<button class='fb-secondary fb-p05 fb-rad7 fb-m05' type='submit' name='submit' value='Login' ><img src='".DB::$dir_imm."utente.png' alt='utente' height='25' />&nbsp;&nbsp;&nbsp;&nbsp;Accedi</button>";

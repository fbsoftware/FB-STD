...
// modifica     
    case 'modifica':
     $btx = new bottoni_str_par('Articoli in colonne','arc','write_arc.php',array('salva|modifica','ritorno'));     
     $btx->btn();
...
// cancellazione    
    case 'cancella' :
$btg = new bottoni_str_par('Modulo articolo-colonne','arc','write_arc.php',array('salva|cancella','ritorno'));     
     $btg->btn();
      $sql = "SELECT * FROM `".DB::$pref."arc` 
               WHERE `hid` = $hid  "; 
	echo	"<fieldset>";  

  ...
  <div id="panel-body" class="accordion">
      ...
      <div style="display: flex;">
        ...
        <select data-prop="color">
          <option value="var(--primary)"    ${widget.props?.color === 'var(--primary)' ? 'selected' : ''}>Primary</option>
          <option value="var(--secondary)"  ${widget.props?.color === 'var(--secondary)' ? 'selected' : ''}>Secondary</option>
          <option value="var(--accent)"     ${widget.props?.color === 'var(--accent)' ? 'selected' : ''}>Accent</option>
          <option value="var(--text)"       ${widget.props?.color === 'var(--text)' ? 'selected' : ''}>Testo</option>
          <option value="custom">🎨 Custom...</option>
        </select>
        <input type="color" data-custom-color hidden>
      </div>
      ...
      $panel.append(`
        ...
        <div style="display: flex;">
          ...
          <select data-prop="color">
            ...
            <option value="var(--text)">Testo</option>
            <option value="custom">🎨 Custom...</option>
          </select>
          <input type="color" data-custom-color hidden>
        </div>

...
if ($isEmpty != 1)
    {
        ...
        for ($i=0; $i < $n; $i++)
        {
               ...
               if ($this->errore[$i] > -1  &&  $this->errore[$i] < 51)
                    ...
                    echo "<p class='fb-p1'><img src='".DB::$dir_imm."/attenzione.png' height=20 alt='stop'>";}
                    // success  51 - 100
               if ($this->errore[$i] > 50  &&  $this->errore[$i] < 101)
                    {echo "<div class='fb-highlight'>";
                    echo "<p class='fb-p1'><img src='".DB::$dir_imm."/ok.png' height=20 alt='ok'>"; }
                    // warning  101 - 150
               if ($this->errore[$i] > 100  &&  $this->errore[$i] < 151)
                    { echo "<div class='fb-info'>";
                    echo "<p class='fb-p1'><img src='".DB::$dir_imm."/info.png' height=20 alt='nota'>";}
                    // info  151 - 200
               if ($this->errore[$i] > 150  &&  $this->errore[$i] < 201)
                    { echo "<div class='fb-attenzione'>";
                    echo "<p class='fb-p1'><img src='".DB::$dir_imm."/stop.png' height=20 alt='info'>"; }
              // messaggio

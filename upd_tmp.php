...
/*** Fausto Bresciani   fbsoftware@libero.it  www.fbsoftware.altervista.org
   ...
   * gestione tabella template   
	17/8/19  aggiunto campo "teditor" e gestione con tabs.
============================================================================= */
...
?>
  ...
  <ul>
    ...
    <li><a href="#tabs-1">Slide</a></li>
    <li><a href="#tabs-2">Promo</a></li>
    <li><a href="#tabs-3">Accordion</a></li>
	<li><a href="#tabs-4">Portfolio</a></li>
	<li><a href="#tabs-5">Contatti</a></li>
    <li><a href="#tabs-6">Art. Tab</a></li>
    <li><a href="#tabs-7">Art. Slide</a></li>
    <li><a href="#tabs-8">Glifi</a></li>
  </ul>
 <?php			
	...
	echo "<fieldset>";  
     ...
     $tz = new DB_tip_i('lin','tlang','','Lingua','Lingua per traduzione label');        
      ...
      $tz = new DB_tip_i('color','tcolor','','Colore base','Colore di base di pulsanti,glifi,barre ecc.');        
          $tz->select(); 
      $tz = new DB_tip_i('tedit','teditor','','Editore per testi','Editore per testi');        
          $tz->select(); 
	echo "</fieldset>";
	echo "</div>";
...
if (TMP::$teditor == 'ckeditor') 
	{  echo "<script type='text/javascript'>CKEDITOR.replace('tpromotext');</script>"; }
...
// tabs-3 accordion ---------------------------------------------------------------
	...
	echo "<fieldset>"; 
     ...
     $input    = new input(array('','taccotext',50,'Testo','Testo della sezione dei promo','tx'));
          $input->field();
if (TMP::$teditor == 'ckeditor') 
	{  echo "<script type='text/javascript'>CKEDITOR.replace('taccotext');</script>"; }
	echo "</fieldset>";
	echo "</div>";
...
// tabs-4 portfolio ---------------------------------------------------------------    
	...
	echo "<fieldset>"; 
     ...
     $input    = new input(array('','tportext',50,'Testo','Testo della sezione portfolio','tx'));
          $input->field(); 
if (TMP::$teditor == 'ckeditor') 
	{  echo "<script type='text/javascript'>CKEDITOR.replace('tportext');</script>"; }		  
	echo "</fieldset>";
	echo "</div>";
// tabs-5 contatti ---------------------------------------------------------------    
	echo "<div id='tabs-5' class='row'>";
	echo "<fieldset>"; 
     ...
     $input    = new input(array('','tcttext',50,'Testo','Testo della sezione contatti','tx'));
          $input->field(); 
if (TMP::$teditor == 'ckeditor') 
	{  echo "<script type='text/javascript'>CKEDITOR.replace('tcttext');</script>"; }		  
	echo "</fieldset>";
	echo "</div>"; 
// tabs-6 articoli in tab ---------------------------------------------------------------   
	echo "<div id='tabs-6' class='row'>";
	echo "<fieldset>"; 
     ...
     $input    = new input(array('','ttabtext',50,'Testo','Testo della sezione slide','tx'));
          $input->field();
if (TMP::$teditor == 'ckeditor') 
	{  echo "<script type='text/javascript'>CKEDITOR.replace('ttabtext');</script>"; }		  
	echo "</fieldset>";
	echo "</div>"; 
	
// tabs-7 articoli in slide ---------------------------------------------------------------   
	echo "<div id='tabs-7' class='row'>";
	echo "<fieldset>"; 
     ...
     $input    = new input(array('','tsldtext',50,'Testo','Testo della sezione contatti','tx'));
          $input->field(); 
if (TMP::$teditor == 'ckeditor') 
	{  echo "<script type='text/javascript'>CKEDITOR.replace('tsldtext');</script>"; }		  
	echo "</fieldset>";
	echo "</div>"; 	
	
// tabs-8 glifi ---------------------------------------------------------------   
	echo "<div id='tabs-8' class='row'>";
	echo "<fieldset>";      $tz = new DB_tip_i('s-n','tgliftitle',0,'Mostra titolo','Visualizza o meno il titolo');        
        $tz->select(); 
    ...
    $input    = new input(array('','tgliftext',50,'Testo','Testo sezione dei glifi','tx'));
		$input->field();
if (TMP::$teditor == 'ckeditor') 
	{  echo "<script type='text/javascript'>CKEDITOR.replace('tgliftext');</script>"; }
	...
	echo "<fieldset>";      
     ...
     $tz = new DB_tip_i('lin','tlang',$tlang,'Lingua','Lingua per traduzione label');        
      ...
      $tz = new DB_tip_i('color','tcolor',$tcolor,'Colore base','Colore di base del template');        
          $tz->select(); 
      $tz = new DB_tip_i('tedit','teditor',$teditor,'Editore per testi','Editore per testi');        
          $tz->select();		  
	echo "</fieldset>"; 
	echo  "</div>";    
